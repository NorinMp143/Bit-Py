...
OR=bin(c).lstrip('0b')
window2=Tk()
window2.title("OR-Bitwise Operation")
...
Label(window2,text="OR:",width=10,bg="WHITE",fg="black",font="none 12 bold").grid(row=6,column=3)
Label(window2,text=OR,width=20,bg="WHITE",fg="black",font="none 12 bold").grid(row=6,column=4)
