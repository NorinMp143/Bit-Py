...
AD=bin(c).lstrip('0b')
window2=Tk()
window2.title("AND-Bitwise Operation")
...
Label(window2,text="AND:",width=10,bg="WHITE",fg="black",font="none 12 bold").grid(row=6,column=3)
Label(window2,text=AD,width=20,bg="WHITE",fg="black",font="none 12 bold").grid(row=6,column=4)
